        ...
        <div class="jumbotron-wrap">
            <div class="container-fluid">
                <div class="jumbotron jumbotron-narrow static-slider">
                    <h1 class="text-center">Successfully Updated</h1>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-8">
                    <article>
                        ...
                        <blockquote><p>Successfully update. Your data had been saved in the system. Please login back into the system. Click "Login" button to access the system. Use your Username and IC Number to login into the system. </p></blockquote>
                        <br><br><br><br><br>
                    </article>
                </div>
